...
As part of this change, the team has also decided to change the letters to lower-case rather than upper-case.

## [Question Source](https://exercism.org/tracks/typescript/exercises/etl)
